...
public class DisabledLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disabled_login);
        ...
        TextView mNoAccountSignUp = findViewById(R.id.noAccountSignUp);
        mNoAccountSignUp.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                //Intent intent = new Intent(this, registerNewDisabled);
            }
        });
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                builder.setTitle("Повторите вход").setMessage("Пользователь не найден").
